          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p
                className="text-lg leading-relaxed"
                style={{ color: "#3D2B1A" }}
              >Вас ждут: яркие персонажи, азарт, любовь, эталонная сатира, волнующий джаз, чувственное танго, стильные костюмы и декорации! Лёд тронулся, господа присяжные заседатели! Вы никогда не будете лишним на этом празднике жизни!</p>
            </div>
