          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p
                ...
                style={{ color: "#3D2B1A" }}
              >Острая сатира на советский быт, галерея незабываемых персонажей и блистательные диалоги Ильфа и Петрова оживают на сцене в полную силу.

Вас ждут: яркие персонажи,  азарт, любовь, волнующий джаз, чувственное танго, стильные костюмы и декорации! Лед тронулся, господа присяжные заседатели! Вы никогда не будете лишним на этом празднике жизни! </p>
            </div>
